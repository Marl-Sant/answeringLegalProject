...
/*
  I made this component for its reusable nature and versatility. It's polymorphic nature
  could render <button> or Next.js <Link> via a union so one call-to-action covers both
  actions and links
  I've enforced strong typing with explicit prop types and prevented invalid combinations
  like an href on a button.
  I've also used my baseClasses and cx() function to compose Tailwind classes cleanly,
  allowing to extend via className and overiding spacing with an optional padding prop
*/
